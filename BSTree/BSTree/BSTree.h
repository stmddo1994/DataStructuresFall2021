...
private:
	...
	void copyTree(TreeNode<ItemType>*& copy, const TreeNode<ItemType>*
		origTree);
...
template<class ItemType>
inline void BSTree<ItemType>::retrieve(TreeNode<ItemType>*& tree, ItemType& item, bool& found)
{
	if (tree == NULL)
		found = false;
	else if (item < tree->data)
...
template<class ItemType>
inline void BSTree<ItemType>::getPredecessor(TreeNode<ItemType>* tree, ItemType& item)
{
...
template<class ItemType>
inline void BSTree<ItemType>::preOrder(TreeNode<ItemType>* tree, QueArrT<ItemType>& q)
{
	if (tree != NULL)
	{
...
template<class ItemType>
inline void BSTree<ItemType>::postOrder(TreeNode<ItemType>* tree, QueArrT<ItemType>& q)
{
	if (tree != NULL)
	{
...
template<class ItemType>
inline void BSTree<ItemType>::inOrder(TreeNode<ItemType>* tree, QueArrT<ItemType>& q)
{
	if (tree != NULL)
	{
